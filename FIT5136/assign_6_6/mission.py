...
class Mission:
    ...
    coor_name = ''
    jobs = [Job('software enginner','have a good programming'),Job('project manager','familiar with process of project')]
    employees_require = Employment_requirement(['enginners','builders','project manager' ],{'enginners':5,'builders':3,'project manager':1 })
    cargo_require = [Cargo_requirement('mission','concrete, desserts, water'),Cargo_requirement('journey','chicken')]
    launch_date = ''
    ...
    def __init__(self,mission_id=0, mission_name='', mission_description='', country_of_origin='',
    countries_allowed_list='',coor_name='',launch_date='', destination_location='',
    mission_duration=0,mission_status='',has_shuttle=0,can_reject = False
    ):
